...
?>
<style>
    .contacto-admin-page .badge-estado {
        font-size: 0.7rem;
        padding: 0.25rem 0.5rem;
        font-weight: 600;
    }
    .contacto-admin-page .badge-nuevo { background: rgba(59,130,246,0.15); color: #3b82f6; }
    .contacto-admin-page .badge-leido { background: rgba(107,114,128,0.15); color: #6b7280; }
    .contacto-admin-page .badge-respondido { background: rgba(34,197,94,0.15); color: #22c55e; }
    .contacto-admin-page .msg-mensaje {
        font-size: 0.85rem;
        color: #6b7280;
        max-width: 300px;
        white-space: nowrap;
    ...
    body.dark .contacto-admin-page .msg-mensaje { color: #94a3b8; }
</style>

<div class="container-fluid py-3 contacto-admin-page">
    <div class="page-head mb-4">
        <h3><i class="fas fa-envelope me-2"></i>Mensajes de Contacto</h3>
        <p class="text-muted mb-0">Mensajes enviados desde el formulario de contacto</p>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title"><i class="fas fa-envelope me-2"></i>Detalle del Mensaje</h6>
...
(function() {
    ...
    document.getElementById('btnMarcarLeido').addEventListener('click', function() {
        ...
        fetch('<?= url('/sugerencias/actualizar-estado') ?>', {
            ...
            body: JSON.stringify({ tipo: 'contacto', id: parseInt(currentId), estado: 'Leido' })
        })
        .then(function(r) { return r.json(); })
        .then(function(res) {
            if (res.success) {
